...
| `roblox://navigation/profile` <br />Search Parameters:<br />- groupId<br />- userId | `www.roblox.com/users/{userId}/profile` or `www.roblox.com/communities/{groupId}/name` | Open webview of a user or community on the website
