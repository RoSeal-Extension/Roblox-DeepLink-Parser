...
| `roblox://navigation/profile` or `roblox://navigation/group` <br />Search Parameters:<br />- groupId<br />- userId<br />- id (navigation/group only) | `www.roblox.com/users/{userId}/profile` or `www.roblox.com/communities/{groupId}/name` | Open webview of a user or group on the website
